...
Вы можете попробовать RouterOS сегодня, зайдите на mikrotik.com и загрузите установочный компакт-диск. Бесплатная пробная версия предоставляет все функции без ограничений. На следующих страницах вы найдете примеры некоторых наиболее важных функций RouterOS.
конфигурация
